...
/*!\addtogroup HASH_ripemd256_m
 * \{
 */

/*@unchecked@*/ /*@observer@*/
static uint32_t ripemd256hinit[8] =
...
int ripemd256Reset(register ripemd256Param* mp)
{
/*@-sizeoftype@*/
        memcpy(mp->h, ripemd256hinit, 8 * sizeof(uint32_t));
...
static void ripemd256Finish(ripemd256Param* mp)
        /*@modifies mp @*/
{
...
/*@-protoparammatch@*/
int ripemd256Digest(ripemd256Param* mp, byte* data)
{
        ripemd256Finish(mp);

        /* encode 8 integers little-endian style */
        data[ 0] = (byte)(mp->h[0]      );
