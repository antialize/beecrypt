...
#ifndef _INTERFACE_ECPRIVATEKEY_H
#define _INTERFACE_ECPRIVATEKEY_H

#ifdef __cplusplus

#include "beecrypt/c++/security/interfaces/PrivateKey.h"
using beecrypt::security::interfaces::PrivateKey;
