...
#ifndef _CLASS_BEE_SECURITY_INVALIDKEYEXCEPTION_H
#define _CLASS_BEE_SECURITY_INVALIDKEYEXCEPTION_H
...
namespace beecrypt {
	namespace security {
		...
		public:
			...
			inline InvalidKeyException(const char* message) : KeyException(message)
			{
			}
