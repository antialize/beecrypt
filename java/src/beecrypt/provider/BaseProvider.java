		...
		AccessController.doPrivileged(new java.security.PrivilegedAction()
			{
				public Object run()
				{
				//	setProperty("AlgorithmParameterGenerator.DH", "beecrypt.provider.DHParameterGenerator");
					setProperty("AlgorithmParameters.DH", "beecrypt.provider.DHParameters");
					setProperty("AlgorithmParameters.DHIES", "beecrypt.provider.DHIESParameters");
				//	setProperty("AlgorithmParameters.DSA", "beecrypt.provider.DSAParameters");
					...
					setProperty("KeyPairGenerator.DH", "beecrypt.provider.DHKeyPairGenerator");
					...
					setProperty("Als.Alias.AlgorithmParameterGenerator.DiffieHellman", "AlgorithmParameterGenerator.DH");
					setProperty("Als.Alias.AlgorithmParameters.DiffieHellman", "AlgorithmParameters.DH");
					setProperty("Als.Alias.AlgorithmParameters.DHAES", "AlgorithmParameters.DHIES");
					setProperty("Als.Alias.AlgorithmParameters.DHES", "AlgorithmParameters.DHIES");
					...
					setProperty("Als.Alias.KeyPairGenerator.DiffieHellman", "KeyPairGenerator.DH");
